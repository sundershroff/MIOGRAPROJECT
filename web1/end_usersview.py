...
@csrf_exempt
def shop(request):
    admin=requests.get("https://miogra.com/admin/get_shutdown").json()
    if admin[0]['shopping'] == False:
        return redirect("/soon/")
    else:
    # print(shopping)
        shopdata = requests.get("https://miogra.com/all_shopproducts").json()
        banner = requests.get("https://miogra.com/admin/banner_display/shopping").json()[0]
        context={
...
def shop_products(request,category):
    product_data=requests.get(f"https://miogra.com/category_based_shop/{category}/").json()
    # print(product_data.content)
    print(type(product_data))
    products=[]
    for x in product_data:
        shop_id= x.get('shop_id')
        shop=requests.get(f"https://miogra.com/my_shopping_data/{shop_id}").json()
...
def shop_based_product(request):
    # product_data=requests.get(f"https://miogra.com/shop_get_products/{id}").json()
    shop_data = requests.get("https://miogra.com/all_shopproducts").json()
...
def single_shopproducts(request,id,product_id):
    single_product=requests.get(f"https://miogra.com/get_single_shopproduct/{id}/{product_id}").json()[0]
    product_review = requests.get(f"https://miogra.com/get_all_reviews/").json()
    review=[]
...
def food(request):
    ...
    if admin[0]['food'] == False:
        ...
        food_data= requests.get("https://miogra.com/all_foodproducts/").json()
        shop_data =requests.get("https://miogra.com/food_alldata").json()
        banner = requests.get("https://miogra.com/admin/banner_display/food").json()[0]
        print(shop_data)
...
def food_products(request,category):
    food_product=[]
    food_data=requests.get(f"https://miogra.com/category_based_food/{category}/").json()
    # print(product_data.content)
    print((food_data))
    for x in food_data:
        food_id=x.get('food_id')
        hotel=requests.get(f"https://miogra.com/my_food_data/{food_id}").json()
...
def restaurant_based_products(request,id):
    restaurant=requests.get(f"https://miogra.com/my_food_data/{id}").json()
    products= requests.get(f"https://miogra.com/enduser_resturant_get_products/{id}").json()
...
def single_food_products(request,id,product_id):
    food_data=requests.get(f"https://miogra.com/single_foodproduct/{id}/{product_id}").json()[0]
    reviews=requests.get(f"https://miogra.com/get_product_all_reviews/{product_id}").json()
    # print(product_data.content)
    print((food_data))
...
def fresh_cuts(request):
    ...
    if admin[0]['fresh_cuts'] == False:
        ...
        fresh_data= requests.get("https://miogra.com/all_freshcutproducts/").json()
        banner = requests.get("https://miogra.com/admin/banner_display/fresh_cuts").json()[0]
        print(fresh_data)
...
def fresh_cut_products(request,category):
    fresh_data=requests.get(f"https://miogra.com/category_based_fresh/{category}/").json()
    # print(product_data.content)
    print(type(fresh_data))
    products=[]
    for x in fresh_data:
        shop_id= x.get('fresh_id')
        shop=requests.get(f"https://miogra.com/my_freshcuts_data/{shop_id}").json()
...
def freshShop_based_products(request,id):
    shop=requests.get(f"https://miogra.com/my_freshcuts_data/{id}").json()
    products=requests.get(f"https://miogra.com/fresh_get_products/{id}").json()
    context={
        'shop':shop,
        'fresh_cuts': products
    }
...
def fresh_cut_singel_products(request,id,product_id):
    fresh_data=requests.get(f"https://miogra.com/single_freshproduct/{id}/{product_id}").json()[0]
    reviews = requests.get(f"https://miogra.com/get_product_all_reviews/{product_id}").json()
    # print(product_data.content)
    print((fresh_data))
...
def doriginal(request):
    ...
    if admin[0]['d_original'] == False:
        ...
        dorigin_data= requests.get("https://miogra.com/all_d_originalproducts/").json()
        banner = requests.get("https://miogra.com/admin/banner_display/d_original").json()[0]
        # print(dorigin_data)
        products=[]
        for x in dorigin_data:
            shop_id= x.get('d_id')
            shop=requests.get(f"https://miogra.com/my_d_original_data/{shop_id}").json()
            products.append({'item' : x, 'shop':shop})
...
def dorigin_district_based_products(request,district):
    dorigin_district=requests.get(f"https://miogra.com/d_original_district_based_product/{district}").json()
...
def d_original_single_products(request,d_id,product_id):
    dorigin_data=requests.get(f"https://miogra.com/single_d_originalproduct/{d_id}/{product_id}").json()[0]
    reviews = requests.get(f"https://miogra.com/get_product_all_reviews/{product_id}").json()
...
def daily_mio(request):
    ...
    if admin[0]['daily_mio'] == False:
        ...
        dmio_data= requests.get("https://miogra.com/all_dmioproducts/").json()
        banner = requests.get("https://miogra.com/admin/banner_display/daily_mio").json()[0]
        print(dmio_data)
...
def daily_mio_products(request,category):
    dmio_data= requests.get(f"https://miogra.com/category_based_dmio/{category}/").json()
    print(dmio_data)
    products=[]
    for x in dmio_data:
        shop_id= x.get('dmio_id')
        shop=requests.get(f"https://miogra.com/my_dailymio_data/{shop_id}").json()
        products.append({'item' : x, 'shop':shop})
    context={
        'dmios':products,
    }
...
def dmioshop_based_products(request,id):
    shop=requests.get(f"https://miogra.com/my_dailymio_data/{id}").json()
    products=requests.get(f"https://miogra.com/dmio_get_products/{id}").json()
    context = {
        'shop' : shop,
        'dmios': products
    }
...
def daily_mio_single_products(request,id,product_id):
    dmio_data= requests.get(f"https://miogra.com/get_single_dmio_product/{id}/{product_id}").json()[0]
    reviews = requests.get(f"https://miogra.com/get_product_all_reviews/{product_id}").json()
    print(dmio_data)
...
def jewellery(request):
    ...
    if admin[0]['jewellery'] == False:
        ...
        jewel_data= requests.get("https://miogra.com/all_jewelproducts/").json()
        banner = requests.get("https://miogra.com/admin/banner_display/jewellery").json()[0]
        print(jewel_data)
...
def jewellery_products(request,category):
    jewel_data= requests.get(f"https://miogra.com/category_based_jewel/{category}/").json()
    
    print(jewel_data)
    products=[]
    for x in jewel_data:
        shop_id= x.get('jewel_id')
        shop=requests.get(f"https://miogra.com/my_jewellery_data/{shop_id}").json()
        products.append({'item' : x, 'shop':shop})
    context={
        'jewels': products,
...
def jewelshop_based_products(request,id):
    shop=requests.get(f"https://miogra.com/my_jewellery_data/{id}").json()
    products=requests.get(f"https://miogra.com/jewel_get_products/{id}").json() 
...
def jewellery_single_products(request,id,product_id):
    jewel_data= requests.get(f"https://miogra.com/single_jewelproduct/{id}/{product_id}").json()[0]
    product_review = requests.get(f"https://miogra.com/get_all_reviews/").json()
    reviews=[]
    for x in product_review:
        if product_id == x.get('product_id'):
...
def pharmacy(request):
    ...
    if admin[0]['pharmacy'] == False:
        ...
        pharm_data= requests.get("https://miogra.com/all_pharmproducts/").json()
        banner = requests.get("https://miogra.com/admin/banner_display/pharmacy").json()[0]
        print(pharm_data)
...
def pharmac_products(request,category):
    pharm_data= requests.get(f"https://miogra.com/category_based_pharm/{category}/").json()
    print(pharm_data)
    products=[]
    for x in pharm_data:
        shop_id= x.get('pharm_id')
        shop=requests.get(f"https://miogra.com/my_pharmacy_data/{shop_id}").json()
        products.append({'item' : x, 'shop':shop})
...
def medicalshop_products(request,id):
    shop=requests.get(f"https://miogra.com/my_pharmacy_data/{id}").json()
    products=requests.get(f"https://miogra.com/pharmacy_get_products/{id}").json()
...
def pharmac_single_products(request,id,product_id):
    pharm_data= requests.get(f"https://miogra.com/single_pharmproduct/{id}/{product_id}").json()[0]
    reviews = requests.get(f"https://miogra.com/get_product_all_reviews/{product_id}").json()
...
def used_product(request):
    used_product=requests.get("https://miogra.com/get_allused_products/").json()
    # print(used_product)
...
def used_product_category(request,subcategory):
    used_product=requests.get(f"https://miogra.com/get_used_products_category/{subcategory}/").json()
    # print(used_product)
    print(type(used_product))
    # products=[]
    # for x in pharm_data:
...
def usedproduct_single_data(request,product_id):
    used_data= requests.get(f"https://miogra.com/get_single_used_products/{product_id}").json()
...
def signout_view(request,id):
    # mydata = requests.get(f"https://miogra.com/single_users_data/{id}").json()[0]
    logout(request)
    return redirect("/")
...
def usersignup(request):
    ...
    if request.method == "POST":
        ...
        if request.POST['password'] == request.POST['confirm_password']:
                response = requests.post("https://miogra.com/end_user_signup/",data=request.POST)
...
def usersignin(request):
    ...
    if request.method == "POST":
        print(request.POST)
        response = requests.post("https://miogra.com/end_user_signin/",data=request.POST)
        uid = jsondec.decode(response.text)
        if response.status_code == 200:
            mydata = requests.get(f"https://miogra.com/single_users_data/{uid}").json()[0]
...
def otp(request,id):
    ...
    if request.method == "POST":
        ...
        print(data)
        response = requests.post(f"https://miogra.com/end_user_otp/{id}", data=data)
        print(response)
        print(response.status_code)
        print(data['user_otp'])
        print(response.text)
...
def profile_picture(request,id):
    if request.method == "POST":
        print(request.FILES)
        response = requests.post(f"https://miogra.com/end_profile_picture/{id}",  files=request.FILES)
        print(response)
        print(response.status_code)
        print(response.text)
        uidd = (response.text[1:-1])
...
def dashboard(request,id):
    ...
    if admin[0]['shopping'] == False:
        ...
        mydata = requests.get(f"https://miogra.com/single_users_data/{id}").json()[0]
        shopdata = requests.get("https://miogra.com/all_shopproducts").json()
        wishlist = requests.get(f"https://miogra.com/all_wishlist/{id}").json()
        banner = requests.get("https://miogra.com/admin/banner_display/shopping").json()[0]
        cartlist= requests.get(f"https://miogra.com/cartlist/{id}").json()
...
def user_shopbased_products(request,id,shop_id):
    mydata = requests.get(f"https://miogra.com/single_users_data/{id}").json()[0]
    product_data=requests.get(f"https://miogra.com/shop_get_products/{shop_id}").json()
    shop_data =requests.get(f"https://miogra.com/my_shopping_data/{shop_id}").json()
    wishlist = requests.get(f"https://miogra.com/all_wishlist/{id}").json()
    cartlist= requests.get(f"https://miogra.com/cartlist/{id}").json()
    cartcount= len(cartlist)
    wishcount= len(wishlist)
...
def user_single_products(request,id,shop_id,product_id):
    mydata = requests.get(f"https://miogra.com/single_users_data/{id}").json()[0]
    single_product=requests.get(f"https://miogra.com/get_single_shopproduct/{shop_id}/{product_id}").json()[0]
    reviews=requests.get(f"https://miogra.com/get_product_all_reviews/{product_id}").json()
    wishlist = requests.get(f"https://miogra.com/all_wishlist/{id}").json()
    cartlist= requests.get(f"https://miogra.com/cartlist/{id}").json()
    cartcount= len(cartlist)
    ...
    if request.method=="POST":
        if "add_cart" in request.POST:
            ...
            response = requests.post(f"https://miogra.com/cart_product/{id}/{product_id}/shopping/",data=data)
            if response.status_code == 200:
        ...
        if "reviewsubmit"  in request.POST:
            ...
            print(data)
            response=requests.post(f"https://miogra.com/create_reviews_for_delivered_products/{id}/{product_id}/",data=data)
            if response.status_code == 201:
                category="shopping"
                rating_up=requests.post(f"https://miogra.com/calculate_average_ratings/{category}")
...
def user_foodpage(request,id):
    ...
    if admin[0]['food'] == False:
        ...
        for x in food_data:
            fid=x.get('food_id')
            rating_up=requests.post(f"https://miogra.com/restautant/review/{fid}")
...
def user_restaurant_products(request,id,food_id):
    mydata = requests.get(f"https://miogra.com/single_users_data/{id}").json()[0]
    restaurant=requests.get(f"https://miogra.com/my_food_data/{food_id}").json()
    products= requests.get(f"https://miogra.com/enduser_resturant_get_products/{food_id}").json()
    wishlist = requests.get(f"https://miogra.com/all_wishlist/{id}").json()
    cartlist= requests.get(f"https://miogra.com/cartlist/{id}").json()
    cartcount= len(cartlist)
    wishcount= len(wishlist)
...
def user_singlefood_products(request,id,shop_id,product_id):
    mydata = requests.get(f"https://miogra.com/single_users_data/{id}").json()[0]
    food_data=requests.get(f"https://miogra.com/single_foodproduct/{shop_id}/{product_id}").json()[0]
    reviews=requests.get(f"https://miogra.com/get_product_all_reviews/{product_id}").json()
    wishlist = requests.get(f"https://miogra.com/all_wishlist/{id}").json()
    cartlist= requests.get(f"https://miogra.com/cartlist/{id}").json()
    cartcount= len(cartlist)
   ...
   # print(product_data.content)
    ...
    if request.method=="POST":
        if "add_cart" in request.POST:
            ...
            response = requests.post(f"https://miogra.com/cart_product/{id}/{product_id}/food/",data=data)
            if response.status_code == 200:
...
def user_freshcut_products(request,id,category):
    ...
    for x in fresh_data:
        ...
        shop=requests.get(f"https://miogra.com/my_freshcuts_data/{fresh_id}").json()
        products.append({'item': x, 'shop': shop})
...
def user_freshcut_shop_products(request,id,fresh_id):
    mydata = requests.get(f"https://miogra.com/single_users_data/{id}").json()[0]
    shop=requests.get(f"https://miogra.com/my_freshcuts_data/{fresh_id}").json()
    products=requests.get(f"https://miogra.com/fresh_get_products/{fresh_id}").json()
    wishlist = requests.get(f"https://miogra.com/all_wishlist/{id}").json()
    cartlist= requests.get(f"https://miogra.com/cartlist/{id}").json()
    cartcount= len(cartlist)
    wishcount= len(wishlist)
...
def user_freshcut_single_products(request,id,shop_id,product_id):
    mydata = requests.get(f"https://miogra.com/single_users_data/{id}").json()[0]
    fresh_data=requests.get(f"https://miogra.com/single_freshproduct/{shop_id}/{product_id}").json()[0]
    reviews=requests.get(f"https://miogra.com/get_product_all_reviews/{product_id}").json()
    wishlist = requests.get(f"https://miogra.com/all_wishlist/{id}").json()
    cartlist= requests.get(f"https://miogra.com/cartlist/{id}").json()
    cartcount= len(cartlist)
    ...
    if request.method=="POST":
        if "add_cart" in request.POST:
            ...
            response = requests.post(f"https://miogra.com/cart_product/{id}/{product_id}/fresh_cuts/",data=data)
            if response.status_code == 200:
                return redirect(f"/user/shopping_cart_products/{id}/")
            else:
                pass
...
def user_doriginal_single_products(request,id,shop_id,product_id):
    mydata = requests.get(f"https://miogra.com/single_users_data/{id}").json()[0]
    dorigin_data=requests.get(f"https://miogra.com/single_d_originalproduct/{shop_id}/{product_id}").json()[0]
    reviews=requests.get(f"https://miogra.com/get_product_all_reviews/{product_id}").json()
    wishlist = requests.get(f"https://miogra.com/all_wishlist/{id}").json()
    cartlist= requests.get(f"https://miogra.com/cartlist/{id}").json()
    cartcount= len(cartlist)
    ...
    if request.method=="POST":
        if "add_cart" in request.POST:
            ...
            response = requests.post(f"https://miogra.com/cart_product/{id}/{product_id}/d_original/",data=data)
            if response.status_code == 200:
                return redirect(f"/products/doriginalproducts/doriginal/{id}")
            else:
                pass
...
def user_dmioshops_products(request,id,dmio_id):
    mydata = requests.get(f"https://miogra.com/single_users_data/{id}").json()[0]
    shop=requests.get(f"https://miogra.com/my_dailymio_data/{dmio_id}").json()
    products=requests.get(f"https://miogra.com/dmio_get_products/{dmio_id}").json()
    wishlist = requests.get(f"https://miogra.com/all_wishlist/{id}").json()
    cartlist= requests.get(f"https://miogra.com/cartlist/{id}").json()
    cartcount= len(cartlist)
    wishcount= len(wishlist)
...
def user_dailymio_single_products(request,id,shop_id,product_id):
    mydata = requests.get(f"https://miogra.com/single_users_data/{id}").json()[0]
    dmio_data= requests.get(f"https://miogra.com/get_single_dmio_product/{shop_id}/{product_id}").json()[0]
    reviews=requests.get(f"https://miogra.com/get_product_all_reviews/{product_id}").json()
    wishlist = requests.get(f"https://miogra.com/all_wishlist/{id}").json()
    cartlist= requests.get(f"https://miogra.com/cartlist/{id}").json()
    cartcount= len(cartlist)
    ...
    if request.method=="POST":
        if "add_cart" in request.POST:
            ...
            response = requests.post(f"https://miogra.com/cart_product/{id}/{product_id}/daily_mio/",data=data)
            if response.status_code == 200:
                return redirect(f"/user/shopping_cart_products/{id}/")
            else:
                pass
...
def user_jewellery_based_products(request,id,jewel_id):
    mydata = requests.get(f"https://miogra.com/single_users_data/{id}").json()[0]
    shop=requests.get(f"https://miogra.com/my_jewellery_data/{jewel_id}").json()
    products=requests.get(f"https://miogra.com/jewel_get_products/{jewel_id}").json()
    wishlist = requests.get(f"https://miogra.com/all_wishlist/{id}").json()
    cartlist= requests.get(f"https://miogra.com/cartlist/{id}").json()
    cartcount= len(cartlist)
    wishcount= len(wishlist) 
...
def user_jewel_single_product(request,id,shop_id,product_id):
    mydata = requests.get(f"https://miogra.com/single_users_data/{id}").json()[0]
    jewel_data= requests.get(f"https://miogra.com/single_jewelproduct/{shop_id}/{product_id}").json()[0]
    reviews=requests.get(f"https://miogra.com/get_product_all_reviews/{product_id}").json()
    wishlist = requests.get(f"https://miogra.com/all_wishlist/{id}").json()
    cartlist= requests.get(f"https://miogra.com/cartlist/{id}").json()
    cartcount= len(cartlist)
    ...
    if request.method=="POST":
        if "add_cart" in request.POST:
            ...
            response = requests.post(f"https://miogra.com/cart_product/{id}/{product_id}/jewellery/",data=data)
            if response.status_code == 200:
                return redirect(f"/user/shopping_cart_products/{id}/")
            else:
                pass
...
def user_pharmacy(request,id):
    ...
    if admin[0]['pharmacy'] == False:
        ...
        for x in pharm_data:
            shop_id= x.get('pharm_id')
            shop=requests.get(f"https://miogra.com/pharmacy_get_products/{shop_id}").json()
            products.append({'item' : x, 'shop':shop})
...
def user_medical_pharmacy_product(request,id,pharm_id):
    mydata = requests.get(f"https://miogra.com/single_users_data/{id}").json()[0]
    shop=requests.get(f"https://miogra.com/my_pharmacy_data/{pharm_id}").json()
    products=requests.get(f"https://miogra.com/pharmacy_get_products/{pharm_id}").json()
    wishlist = requests.get(f"https://miogra.com/all_wishlist/{id}").json()
    cartlist= requests.get(f"https://miogra.com/cartlist/{id}").json()
    cartcount= len(cartlist)
    wishcount= len(wishlist)
...
def user_pharmac_singleproduct(request,id,shop_id,product_id):
    mydata = requests.get(f"https://miogra.com/single_users_data/{id}").json()[0]
    pharm_data= requests.get(f"https://miogra.com/single_pharmproduct/{shop_id}/{product_id}").json()[0]
    wishlist = requests.get(f"https://miogra.com/all_wishlist/{id}").json()
    reviews=requests.get(f"https://miogra.com/get_product_all_reviews/{product_id}").json()
    cartlist= requests.get(f"https://miogra.com/cartlist/{id}").json()
    cartcount= len(cartlist)
    ...
    if request.method=="POST":
        if "add_cart" in request.POST:
            ...
            response = requests.post(f"https://miogra.com/cart_product/{id}/{product_id}/pharmacy/",data=data)
            if response.status_code == 200:
                return redirect(f"/user/shopping_cart_products/{id}/")
            else:
                pass
...
def used_product_index(request,id):
    print(id)
    mydata = requests.get(f"https://miogra.com/single_users_data/{id}").json()[0]
    used_data=requests.get("https://miogra.com/get_allused_products/").json()
    wishlist = requests.get(f"https://miogra.com/all_wishlist/{id}").json()
    cartlist= requests.get(f"https://miogra.com/cartlist/{id}").json()
    cartcount= len(cartlist)
    wishcount= len(wishlist)
...
def user_usedproduct_reg(request,id):
    ...
    if request.method == "POST":
        ...
        response=requests.post(f"https://miogra.com/used_products/{id}",data=cleaned_data_dict,files=request.FILES)
        if response.status_code == 200:
...
def user_add_address_cart(request,id):
    ...
    if request.method == "POST":
        ...
        response=requests.post(f"https://miogra.com/end_user_address/{id}",request.POST)
        if response.status_code == 200:
...
def user_address_cartchange(request,id,change):
    ...
    if request.method == "POST":
        ...
        response=requests.post(f"https://miogra.com/update_end_user_address/{id}/",data=data)
        if response.status_code == 200:
            print("changed")
            return redirect(f"/user_cart_to_checkout/{id}")
        else:
...
def user_checkout_page(request,id,category,shop_id,product_id):
    ...
    if category == "shopping":
        products=requests.get(f"https://miogra.com/get_single_shopproduct/{shop_id}/{product_id}").json()[0]
    elif category == "food":
        products=requests.get(f"https://miogra.com/single_foodproduct/{shop_id}/{product_id}").json()[0]
    elif category == "freshcuts":   
        products=requests.get(f"https://miogra.com/single_freshproduct/{shop_id}/{product_id}").json()[0]
    elif category == "doriginal":
        products=requests.get(f"https://miogra.com/single_d_originalproduct/{shop_id}/{product_id}").json()[0]
    elif category == "dmio":
        products= requests.get(f"https://miogra.com/get_single_dmio_product/{shop_id}/{product_id}").json()[0]
    elif category == "jewellery":
        products= requests.get(f"https://miogra.com/single_jewelproduct/{shop_id}/{product_id}").json()[0]
    elif category == "pharmacy":
        products= requests.get(f"https://miogra.com/single_pharmproduct/{shop_id}/{product_id}").json()[0]
    else:
        print("no data")
...
def user_payment_option(request,id,category,shop_id,product_id,qty,d_a):
    ...
    if "order_place" in request.POST:
        ...
        response = requests.post(f"https://miogra.com/enduser_order_create/{id}/{product_id}/{category}/",data = data)
        if response.status_code == 200:
            print("Order placed")
...
def add_to_cart(request,id,category,shop_id,product_id):
    ...
    #     'quantity' : quantity
    #         }
    #     response = requests.post(f"https://miogra.com/cart_product/{id}/{product_id}/{category}/",data=data)
...
def user_shopping_cart(request,id):
    ...
    carts = requests.get(f"https://miogra.com/cartlist/{id}").json()
    wishlist = requests.get(f"https://miogra.com/all_wishlist/{id}").json()
    cartlist= requests.get(f"https://miogra.com/cartlist/{id}").json()
    cartcount= len(cartlist)
    wishcount= len(wishlist)
    ...
    if request.method == "POST":
        if "cart_del" in request.POST:
            ...
            dele_data = requests.post(f"https://miogra.com/cartremove/{id}/{cart_id}/")
            ...
            if quantity > 0:
                ...
                print(data)
                response=requests.post(f"https://miogra.com/cartupdate/{cart_id}",data=data)
                if response.status_code == 200:
                    return redirect(f"/user/shopping_cart_products/{id}/")
                else:
                    pass
...
def cart_to_checkout(request,id):
    ...
    wishlist = requests.get(f"https://miogra.com/all_wishlist/{id}").json()
    cartlist= requests.get(f"https://miogra.com/cartlist/{id}").json()
    delivery_charge=requests.get(f"https://miogra.com/admin/normal_delivery_commision").json()
...
def user_cart_payment(request,id,add):
    ...
    wishlist = requests.get(f"https://miogra.com/all_wishlist/{id}").json()
    cartlist= requests.get(f"https://miogra.com/cartlist/{id}").json()
    delivery_fees=requests.get(f"https://miogra.com/admin/normal_delivery_commision").json()
    cartcount= len(cartlist)
    wishcount= len(wishlist)
    tot=0
    for i in cartlist:
    ...
    if "order_place" in request.POST:
        ...
        if request.POST['paymentMethod'] == "netBanking":
            ...
            response = requests.post(f"https://miogra.com/razor_pay_order", data={"amount":request.POST['order_place']})
            if response.status_code == 200:
                print(response.text)
            ...
            for x in cart_data:
                ...
                if category.lower() in ["shopping", "daily_mio", "food", "d_original", "jewellery", "pharmacy", "fresh_cuts"]:
                    ...
                    response = requests.post(f"https://miogra.com/enduser_order_create/{id}/{product_id}/{category}/", data=data)
                    if response.status_code == 200:
                        cart_del = requests.post(f"https://miogra.com/cartremove/{id}/{cart_id}/")
                        orders_created = True
                    else:
...
def add_to_wishlist(request,id,category,product_id):
    ...
    response = requests.post(f"https://miogra.com/whishlist_product/{id}/{product_id}/{category}/",data=data)
    print(response)
    if response.status_code == 200:
...
def user_wish_list_data(request,id):
    mydata = requests.get(f"https://miogra.com/single_users_data/{id}").json()[0]
    wish_list = requests.get(f"https://miogra.com/all_wishlist/{id}").json()
    wishlist = requests.get(f"https://miogra.com/all_wishlist/{id}").json()
    cartlist= requests.get(f"https://miogra.com/cartlist/{id}").json()
    cartcount= len(cartlist)
    wishcount= len(wishlist)
    ...
    if request.method=="POST":
        if "wish_del" in request.POST:
            ...
            print(id)
            delete_data = requests.post(f"https://miogra.com/remove_wish/{id}/{product_id}/")
        ...
        if "cartup" in request.POST:
            ...
            response = requests.post(f"https://miogra.com/cart_product/{id}/{product_id}/{category}/",data=data)
            if response.status_code ==200:
                remove_wish = requests.post(f"https://miogra.com/remove_wish/{id}/{product_id}/")
...
def user_order_data(request,id):
    mydata = requests.get(f"https://miogra.com/single_users_data/{id}").json()[0]
    order_data = requests.get(f"https://miogra.com/enduser_order_list/{id}/").json()
    wishlist = requests.get(f"https://miogra.com/all_wishlist/{id}").json()
    cartlist= requests.get(f"https://miogra.com/cartlist/{id}").json()
    cartcount= len(cartlist)
    wishcount= len(wishlist)
...
def tracking_order(request,id,order_id):
    mydata = requests.get(f"https://miogra.com/single_users_data/{id}").json()[0]
    order_data = requests.get(f"https://miogra.com/user_product_timeline/{order_id}").json()
    wishlist = requests.get(f"https://miogra.com/all_wishlist/{id}").json()
    cartlist= requests.get(f"https://miogra.com/cartlist/{id}").json()
    cartcount= len(cartlist)
    wishcount= len(wishlist)
...
def user_product_return(request,id,order_id):
    mydata = requests.get(f"https://miogra.com/single_users_data/{id}").json()[0]
    response=requests.post(f"https://miogra.com/user_product_order_status_return/{id}/{order_id}/")
    if response.status_code == 200:
        return redirect(f"/user_order_product_list/{id}")
    else:
        print("error")
